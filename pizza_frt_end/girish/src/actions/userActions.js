...
export const signup = (
  ...
  return (dispatch) => {
    ...
    const url = "http://localhost:7860/pizza/user/register";
    axios
...
export const signin = (userEmail,       userPassword,
  ...
  return (dispatch) => {
    ...
    const url = "http://localhost:7860/pizza/user/login";
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const displayHotels = () => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7860/hotel/hotels';
...
export const displayHotelsById = (hotel_id) => {
  return (dispatch) => {
    ...
    const url = 'http://localhost:7860/items/itemsbyhotel/'+hotel_id;
...
export const UpdateProfile = (userId,name,address,phoneNumber) => {
  ...
  return (dispatch) => {
    ...
    const url = "http://localhost:7860/users/edit/"+userId;
    axios
      .put(url, body, header)
      .then((response) => {
        dispatch({
...
export const updatePassword = (userId,password) => {
  return (dispatch) => {
    ...
    const url = "http://localhost:7860/users/updatepwd/"+userId;
    axios
      .put(url, body, header)
      .then((response) => {
        dispatch({
